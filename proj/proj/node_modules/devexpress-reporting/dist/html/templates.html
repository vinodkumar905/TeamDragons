...
<div class="breadcrumbs-wrapper" data-bind="dxMutationObserver: keyboardHelper" aria-label="Breadcrumbs" role="navigation">
    <!-- ko foreach: listItems -->
    <!-- ko if: $index() !== ($parent.listItems.length - 1) -->
    <a class="breadcrump-link breadcrumb-item dxd-text-accented dx-accessibility-border-accented" data-bind="click: function(s, e) { $parent.onClick($data.position); }">
    ...
    <!-- /ko -->
    <!-- ko if: $index() === ($parent.listItems.length - 1) -->
    <div class="breadcrumb-item dxd-text-primary dx-accessibility-border-accented" aria-current="location">
        <span data-bind="text: $data.displayText"></span>
    </div>
    <!-- /ko -->
